...
class Eventarc
{
	...
	/**
	 * Resend a attendees confirmatin email. If the event transaction id is not valid or
	 * active then this will fail.
	 * 
	 * @access public
	 * @return array The result array
	 */
	public function attendee_resendemailbyrego(array $params)
	{
		return $this->call('eventarc.attendee.resendemailbyrego', $params);
	}
	 ...
	 * @return array The result array
	 */
	public function attendee_delete(array $params)
	{
		return $this->call('eventarc.attendee.delete', $params);
	}
